<?php
	...
	$body = "The following lyric has just been requested\n\nSong: " . $_POST['title'] . "\nArtiste" . $_POST['artist'];
    ...
    <div class="content">
    	<div class="columns">
        	<div style="background: #000; position: relative; top: 20px; left: 60px; width: 457px; padding: 5px; height: 100%; float: left;">
            	<h2>thank you</h2>
				your lyrics have been requested. each song is vetted before it is shown live so please be patient your lyrics
