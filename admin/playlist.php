<?php
	...
	if(isset($_POST['title'])){
		$sql = "INSERT INTO playlists(Name) VALUES ('" . $_POST['title'] . "')";
		mysql_query($sql);
	}
...
<body>
    ...
    <div class="content">
    	<div class="columns">
            <div style="background: #000; position: relative; top: 20px; left: 60px; width: 457px; padding: 5px; height: 150px; float: left;">
                <h2>add playlist</h2>
            ...
            <div style="background: #000; position: relative; top: 20px; right: 140px; width: 260px; padding: 5px; height: 100%; float: right;">
            	<h2>playlists</h2>
                <form method="post" action="playlist.php" name="list">
                <table cellpadding="5">
                	<?php 
						...
						if(!$result = mysql_query($sql)){
							...
							while($row = mysql_fetch_array($result)){
								echo ("<tr><td><a href='delete.php?playlist=" . $row['ID'] . "'><img src='../images/delete-icon.png' alt='Remove' border='0' /></a></td><td>" . $row['Name'] . "</td></tr>");
