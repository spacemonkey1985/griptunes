<?php
	...
	if(isset($_POST['name'])){
		$sql = "INSERT INTO lyrics (Originator, Email, Song, Artist, Artist2, Album, Lyrics, YouTube, DateTimeStamp, Active) VALUES ('" . $_POST['name'] . "', '" . $_POST['email'] . "', '" . $_POST['title'] . "', '" . $_POST['artist'] . "', '" . $_POST['artist2'] . "', '" . $_POST['album'] . "', '" . $_POST['lyrics'] . "', '" . $_POST['youtube'] . "', CURDATE(), 0)";
	...
	$body = "The following lyric has just been added by " . $_POST['name'] . "\n\nSong: " . $_POST['title'] . "\nArtiste" . $_POST['artist'];

	mail($to, $subject, $body, 'From: info@griptime.com');

	$to = $_POST['email'];
	$subject = 'Thank you for your input';
	$body = "Thank you for you lyric submission. These will be vetted and added to the site very soon!";
    ...
    <div class="content">
    	<div class="columns">
        	<div style="background: #000; position: relative; top: 20px; left: 60px; width: 457px; padding: 5px; height: 100%; float: left;">
            	<h2>thank you</h2>
				your lyrics have been submitted. each song is vetted before it is shown live so please be patient your lyrics
                will be shown live soon!<br /><br />
				click <b><a href="add_lyrics.php">here</a></b> to add another <b><a href="add_lyrics.htm">lyric...</a></b>
                <br /><br />
				<a href="add_lyrics.php"><img src="images/add-button-small.png" alt="Add More" border="0" /></a>
            </div>
